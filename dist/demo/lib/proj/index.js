(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('ol/proj/proj4'), require('ol/proj')) :
  typeof define === 'function' && define.amd ? define(['ol/proj/proj4', 'ol/proj'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.index = factory(global.proj4$1, global.proj));
}(this, (function (proj4$1, proj) { 'use strict';
  ...
  */
  ...
  const registerProjection = (code, proj4Str, options = {}) => {
    ...
    return new proj.Projection(opt);
  };
